...
- [三、 核心模块化详细说明](#三-核心模块化详细说明)
  - [3.1 多通道传感器硬件流水线 (Sensor Multi-Channel Pipeline)](#31-多通道传感器硬件流水线)
  - [3.2 KPU 硬件加速 YOLOv5 nano 目标检测与 ROI 空间滤波](#32-kpu-硬件加速-yolov5-nano-目标检测与-roi-空间滤波)
  - [3.3 几何标定与物理空间坐标解算 (Coordinate Transformation)](#33-几何标定与物理空间坐标解算)
  - [3.4 100Hz 高频低时延串口控制链路 (UART Fast Control Link)](#34-100hz-高频低时延串口控制链路)
